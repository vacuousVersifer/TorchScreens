...
public class RenderBatch implements Comparable<RenderBatch> {
    ...
    private final PictureRenderer[] sprites;
    ...
    public RenderBatch(int maxBatchSize, int zIndex) {
        ...
        this.sprites = new PictureRenderer[maxBatchSize];
    ...
    public void addSprite(PictureRenderer spr) {
...
//            flip(vertices);
    ...
    private void loadVertexProperties(int index) {
        PictureRenderer sprite = this.sprites[index];
